...
pub enum WikiScope {
    /// Searches: .arags/wiki/searches/
    Searches,
    /// Analyses: .arags/wiki/analyses/
    Analyses,
    /// Decisions: .arags/wiki/decisions/
    Decisions,
    /// Sessions: .arags/wiki/sessions/
    Sessions,
    /// Trajectories: .arags/wiki/trajectories/
    Trajectories,
    /// Global rules: .arags/wiki/_global/
    Global,
}
