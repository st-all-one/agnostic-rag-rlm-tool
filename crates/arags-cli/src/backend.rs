...
pub fn resolve_backend(
    ...
    let api_key = std::env::var(match kind {
        arags_llm::BackendKind::OpenAI => "OPENAI_API_KEY",
        arags_llm::BackendKind::Anthropic => "ANTHROPIC_API_KEY",
        arags_llm::BackendKind::Gemini => "GEMINI_API_KEY",
        arags_llm::BackendKind::Ollama => "",
        arags_llm::BackendKind::DeepSeek => "DEEPSEEK_API_KEY",
        arags_llm::BackendKind::MiMo => "MIMO_API_KEY",
    })
    .ok();
