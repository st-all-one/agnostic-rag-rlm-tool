...
//! (`arlm.v1`). The generated file name tracks the package
//! (`arlm.v1.rs`); downstream code keeps referencing `arlm_proto::proto::*`
//! and the `arlm_service_{client,server}` modules, which this crate preserves.
...
pub mod proto {
    ...
    include!(concat!(env!("OUT_DIR"), "/arlm.v1.rs"));
}
