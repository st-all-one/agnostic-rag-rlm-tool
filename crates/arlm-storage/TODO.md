...
- **Decisão:** Fora do escopo do refactor do storage — exigiria mudança nos handlers gRPC do `arlm-server`. Mapear `buffers → ProjectInfo` nos handlers, ou criar `projects` num ciclo futuro do servidor.
